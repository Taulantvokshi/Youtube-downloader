...
/* harmony default export */ __webpack_exports__["default"] = (function (list, format) {
  ...
  list.forEach(function (video) {
    ...
    container.className = 'container'; //Image div

    var imageBox = document.createElement('div');
    imageBox.className = 'imageBox';
    var image = document.createElement('img');
    image.src = video.thumbnail; //Video Title
    ...
    button.addEventListener('click', function (e) {
      ...
      var downloadLoader = document.createElement('div');
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default()({
        ...
        var responseInfo = JSON.parse(response.config.data);
        var file = new File([response.data], responseInfo.title + '.' + responseInfo.format);
        file_saver__WEBPACK_IMPORTED_MODULE_1___default.a.saveAs(file); //Download with Url in this case URL from S3
